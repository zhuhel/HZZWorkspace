...
def plot_limit(path, file_name, xslabel, typelabel, minx=200,maxx=2000):
    ...
    hist_obs,hist_exp,hist_1s,hist_2s = make_limit_graph(path+"4l_cut_VBF.txt")
    hist_obs2,hist_exp2,hist_1s2,hist_2s2 = make_limit_graph(path+"llvv_VBF.txt")
    hist_obs3,hist_exp3,hist_1s3,hist_2s3 = make_limit_graph(path+"combcbin_cut_VBF.txt")
    ...
    legend = ROOT.myLegend(0.56, 0.65, 0.83, 0.88)
    legend.AddEntry(hist_obs3, "Observed Combined", "l")
    legend.AddEntry(hist_exp,  "Expected llll", "l")
    legend.AddEntry(hist_exp2, "Expected llvv", "l")
    legend.AddEntry(hist_exp3, "Expected Combined", "l")
...
if __name__ == "__main__":
    ...
    plot_limit(path,"combcbin_cut_VBF","VBF","NWA, VBF production")
