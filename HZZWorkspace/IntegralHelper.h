...
namespace IntegralHelper{
    ...
    Double_t getTotalIntegral(Double_t mH, Double_t width, Double_t kappa, Double_t acc_0, Double_t acc_1, Double_t acc_2, Double_t a_0, Double_t a_1, Double_t a_2, Double_t a_3, Double_t a_4, Double_t b_0, Double_t b_1, Double_t b_2, Double_t b_3, Double_t b_4);
}
