...
//------------------------------------------------------------------------------
//*** SampleFactory code validating that each PDF has sufficient arguments ***//
//------------------------------------------------------------------------------
...
// ===========================================================
// [0] name
// [1] ROOT file containing input histograms
// [2] ROOT file for systematic shape variations
// [3] MC threshold
...
// ===========================================================
// [0] name
// [1-3] mH initial, lower bound, and upper bound values
// [4] Minitree directory containing input
// [5] ROOT file containing shape systematics
...
SampleBase* SampleFactory::FactoryParametrizedSample( strvec& args ){
    ...
    // Convert parameter's upper and lower bounds to floats
    float plo = s_mH_lo.Atof();
    float phi = s_mH_hi.Atof();

    // Create a new parameterized sample
